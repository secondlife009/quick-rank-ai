...
export const PLANS = [
    {
        ...
        features: [
            ...
            { text: "Limited customer support (email only)", limit: "100 tags" },
            { text: "1 user account" },
            { text: "5 GB storage", tooltip: "5 GB storage" },
        ],
        btn: {
            text: "Start for free",
            href: "#",
    ...
    },
    {
        ...
        features: [
            { text: "All features in the Basic Plan" },
            { text: "Priority customer support (email and chat)", limit: "500 tags" },
            { text: "Up to 3 user accounts" },
            { text: "20 GB storage", tooltip: "20 GB storage" },
            { text: "Monthly performance reports", tooltip: "Monthly performance reports" },
        ],
        btn: {
            text: "Get started",
            href: "#",
    ...
    },
    {
        ...
        features: [
            { text: "All features in the Standard Plan" },
            { text: "Dedicated account manager" },
            { text: "Unlimited user accounts" },
            { text: "100 GB storage", tooltip: "100 GB storage" },
            { text: "Customizable features", tooltip: "Customizable features" },
            { text: "Weekly performance reports", tooltip: "Weekly performance reports" },
        ],
        btn: {
            text: "Contact team",
            href: "#",
